...
| [skills/](skills/) | two Claude Code skills, installed with `bridge-for-agents install-skills`: `notify-user` for writing a notification, `bridge-ops` for running and diagnosing the bridge |
